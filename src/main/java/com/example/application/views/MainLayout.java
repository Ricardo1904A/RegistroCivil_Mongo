...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("Registro Civil");
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("Buscar Ciudadano", BuscarCiudadanoView.class,
                LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
        nav.addItem(new SideNavItem("Ver Ciudadanos", VerCiudadanosView.class,
                LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
        nav.addItem(new SideNavItem("Imprimir Certificado", ImprimirCertificadoView.class,
                LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
